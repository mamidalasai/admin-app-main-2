...
class Form1(Form1Template):
  def __init__(self, **properties):
    ...
    if a == -1:
      ...
      self.label_9.text = self.status_list[-1]
      self.label_39.text= self.gender_list[-1]
      self.label_40.text = self.age_list[-1]
      ...
      self.label_49.text = self.last_confirm_list[-1]
      ...
      self.label_63.text = self.alets_list[-1]
      self.label_72.text = self.terms_list[-1]
      self.label_67.text = self.mail_id_list[-1]
      ...
      self.label_60.text = self.approve_list [-1]
